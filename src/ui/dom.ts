/**
 * Тонкая обвязка над DOM.
 *
 * Приложение обходится без фреймворка, поэтому разметка и код связаны через
 * идентификаторы. Единственное, что здесь важно, — падать громко: пропавший
 * идентификатор должен обнаруживаться сразу, а не превращаться в тихий null,
 * который всплывёт где-то в обработчике через полчаса.
 */
