...
/**
 * Протокол браузера и сигнального сервера. Сервер — тупой ретранслятор:
 * `payload` для него непрозрачен. Файл общий с сервером, чтобы проверка
 * входящих сообщений была ровно одна.
 */
