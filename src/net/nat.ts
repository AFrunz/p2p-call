 ...
 *
 * Symmetric — когда один локальный сокет виден снаружи под разными портами.
 * Совпадение портов браузер схлопывает в один кандидат, поэтому признак
 * обычного NAT — «спросили двоих, расхождения не увидели».
 */
