...
export const en: Record<string, string> = {
  ...
  'exchange.validFor': 'The code is valid for {value} more — paste it on the other device in time. It cannot be extended: this is the browser budget.',
  'exchange.expired': 'The code has expired. Refresh it and send the new one.',
}
